...
public class ARFragment extends Fragment {
    ...
    public void requestPermissions() {
        String[] permissions = new String[]{Permissions.PERMISSION_CAMERA};
        if(useGPS)
            permissions = new String[]{Permissions.PERMISSION_CAMERA, Permissions.PERMISSION_ACCESS_FINE_LOCATION};
    ...
    public boolean checkPermissions() {
        if(ContextCompat.checkSelfPermission(this.getActivity(), Permissions.PERMISSION_CAMERA) == PermissionChecker.PERMISSION_GRANTED &&
           ((useGPS && ContextCompat.checkSelfPermission(this.getActivity(), Permissions.PERMISSION_ACCESS_FINE_LOCATION) == PermissionChecker.PERMISSION_GRANTED) ||
            !useGPS
           )
          )
            return true;
